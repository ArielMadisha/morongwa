...
export const ADMIN_QUICK_MODULES: AdminQuickModule[] = [
  ...
  {
    href: '/admin/registration-intel',
    title: 'Registration IP & location',
    desc: 'See where accounts registered from',
    color: 'sky',
    icon: MapPinned,
    group: 'People',
    gate: S(['users']),
  ...
  {
    href: '/admin/onboarding-agents',
    title: 'Onboarding agents',
    desc: 'WhatsApp Jobs agent applications (name, ID, bank)',
    color: 'sky',
    icon: UserPlus,
    group: 'People',
    gate: S(['fraud_registration', 'tuckshop_cash_agents']),
  },
  {
  ...
  { href: '/admin/dropship', title: 'Dropshipping', desc: 'CJ, EPROLO, SHEIN — import & stock', color: 'cyan', icon: Truck, group: 'Commerce', gate: S(['dropshipping']) },
