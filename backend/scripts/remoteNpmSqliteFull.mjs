...
cur = c.cursor()
cur.execute("SELECT id, domain_names, forward_host, forward_port, forward_scheme, enabled, ssl_forced, certificate_id, advanced_config FROM proxy_host ORDER BY id")
