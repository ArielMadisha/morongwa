...
cur = con.cursor()
cur.execute("update proxy_host set domain_names=? where id=7", (json.dumps(["qwertymates.com","www.qwertymates.com"]),))
con.commit()
cur.execute("select id, domain_names, certificate_id from proxy_host where id=7")
print(cur.fetchone())
con.close()
`;
