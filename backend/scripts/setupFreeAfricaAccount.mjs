#!/usr/bin/env node
/**
 * Rebrand @izqxhis2057 → Free Africa (@freeafrica).
 *
 *   node scripts/setupFreeAfricaAccount.mjs --dry-run
 *   node scripts/setupFreeAfricaAccount.mjs --apply --push-remote
 */
...
const SOURCE_USER_ID = "69cd1cc2703cf9d7f5bbb550";
const SOURCE_USERNAME = "izqxhis2057";
const NEW_NAME = "Free Africa";
const NEW_USERNAME = "freeafrica";
const NEW_PASSWORD = "11111111";
const NEW_EMAIL = "izqxhis2057@user.com";
const NEW_PHONE = "+998995419271";

const POST_TEXT = `BURKINA FASO 🇧🇫: According to our sources, the Minister of Defence, Brigadier General Célestin Simporé, has become very popular within the army and is reportedly causing concern for junta leader Ibrahim Traoré.
This is said to be the reason behind his statement in Ouahigouya: "There cannot be two captains on the same ship."`;

const HASHTAGS = ["FreeAfrica", "BurkinaFaso", "Traore", "Africa", "News"];
...
const SOURCE_IMAGE = path.join(
  ...
  "assets",
  "c__Users_Dell_AppData_Roaming_Cursor_User_workspaceStorage_8cbbb33495ce43c096bb0498540fe740_images_749652087_810264578744549_4677862539271730756_n-ae63ea03-e771-44c7-85a8-470cb6804986.png"
);
...
async function main() {
  ...
  const avatarFile = `profile-${SOURCE_USER_ID}-freeafrica-avatar.png`;
  const tvFile = `tv-${SOURCE_USER_ID}-burkina-faso-simpore-traore.png`;
